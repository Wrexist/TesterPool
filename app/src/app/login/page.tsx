...
export const metadata: Metadata = {
  title: 'Log in',
  description:
    'Sign in to TesterPool with a magic link or Google. Join a pod of 15 developers and get your 12 testers for 14 consecutive days.',
...
export default async function LoginPage({
  ...
  return (
    <main className="flex flex-1 flex-col">
      <LoginForm referral={referral} initialError={initialError} />
    </main>
  );
}
